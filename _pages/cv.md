...
<ol class="patent-list">
  ...
  <li>牛亚峰, <u>王以俨</u>, 黄炜驰, 范林涵. (2025). 基于设计工效学的眼控交互范式设计研究现状与进展. 《包装工程》, 46(4), 20-35.（北大核心、AMI 收录，第二作者）</li>
...
<ol class="patent-list">
  ...
  <li>Y. Niu, <u>Y. Wang</u>, W. Huang, L. Fan. (2025). Research status and progress of eye-control interaction paradigm design based on design ergonomics. <em>Packaging Engineering</em>, 46(4), 20-35. (Chinese core journal / PKU core, AMI-indexed; second author)</li>
