...
paperurl: ''
citation: 'Niu, Y., Tian, J., Xue, C., Wang, Y., Yang, W., & Wang, Y.-Y. (2025). Enhancing gaze interaction performance through fisheye expansion and dynamic trigger strategies. Advanced Engineering Informatics, 65, 103122.'
summary_en: 'The study introduces fisheye-based target enhancement and adaptive trigger mechanisms for better gaze interaction performance in complex interfaces.'
---

研究结合鱼眼扩展与动态触发机制，验证其在提升凝视交互效率与容错表现方面的有效性。
